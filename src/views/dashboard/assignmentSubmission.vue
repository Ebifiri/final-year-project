      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-10 py-6 sm:py-8">
        ...
        >
          <div class="flex flex-col items-center justify-center py-16 sm:py-24 px-4 text-center">
            ...
            <button
              class="px-5 py-2.5 bg-[#1e293b] hover:bg-slate-700 text-white text-sm font-bold rounded-xl transition-colors shadow-md"
        ...
        <div v-if="selectedFiles.length && portalStatus === 'open'" class="mt-6 flex items-center gap-3">
          <button
            class="flex items-center gap-2 px-6 py-3 bg-[#1e293b] hover:bg-slate-700 text-white font-bold rounded-xl transition-colors shadow-md disabled:opacity-60 disabled:cursor-not-allowed"
            :disabled="submitting"
          ...
          <button
            class="px-4 py-3 text-sm text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-xl transition-colors"
            @click="selectedFiles = []"
          >
            Clear all
          </button>
...
import {
  ...
  Loader2, Clock, Award, CheckCircle, XCircle
