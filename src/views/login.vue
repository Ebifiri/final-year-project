    ...
    <div class="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 divide-y sm:divide-y-0 divide-slate-100 px-8 pb-10 gap-8">
        ...
        <div class="flex flex-col gap-4 pt-2 sm:pl-8">
          ...
          <!-- Microsoft 365 -->
          <button class="flex items-center justify-center gap-3 w-full border border-slate-200 hover:border-slate-300 hover:bg-slate-50 rounded-xl py-3 px-4 transition-colors shadow-sm">
            <!-- MS logo SVG -->
          ...
          <!-- Create account -->
          <button class="w-full border-2 border-slate-800 hover:bg-slate-800 hover:text-white text-slate-800 font-bold rounded-xl py-3 px-4 transition-colors">
            Create new account
          </button>
        </div>
      </div>
